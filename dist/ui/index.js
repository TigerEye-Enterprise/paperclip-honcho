...
function SecretSection(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: cardStyle, children: [
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("div", { style: { color: "#475569", fontSize: "0.9rem" }, children: "Choose Honcho Cloud or a self-hosted/local deployment, then paste your Honcho API key below." })
    ] }),
    ...
    /* @__PURE__ */ jsxs("label", { style: labelStyle, children: [
      ...
      /* @__PURE__ */ jsxs("span", { style: { color: "#475569", fontSize: "0.82rem" }, children: [
        "Stored as plain plugin config, not a Paperclip secret reference (that system is currently disabled platform-wide). If you'd rather not put the key here, leave this blank and set a",
        " ",
        /* @__PURE__ */ jsx("code", { children: "HONCHO_API_KEY" }),
        " environment variable on the plugin worker process instead."
      ] })
    ] })
  ] });
}
function SyncProfileSection(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: cardStyle, children: [
    ...
    /* @__PURE__ */ jsxs("label", { style: labelStyle, children: [
      /* @__PURE__ */ jsx("span", { children: "Agent runtime home path template (optional)" }),
      /* @__PURE__ */ jsx(
        "input",
        {
      ...
      /* @__PURE__ */ jsxs("span", { style: { color: "#475569", fontSize: "0.82rem" }, children: [
        `When set, "Initialize Honcho memory" writes an MCP bridge script into this company's Codex runtime home (with `,
        /* @__PURE__ */ jsx("code", { children: "{companyId}" }),
        " substituted) so agents can call Honcho tools on demand. Machine-specific; leave blank to disable."
      ] })
    ] })
  ] });
}
...
function HonchoSettingsPage({ context }) {
  ...
  const canRunConnectionActions = deploymentMode === "cloud" ? Boolean(companyId) : Boolean(companyId && settings.configJson.honchoApiBaseUrl.trim());
